...
public class AleatorioDataSource implements JRDataSource{
      private final Object [][] listadoPeleas;
      private int index;   
    
    public AleatorioDataSource(ObservableList<PeleaT> peleas){
        index = -1;
        listadoPeleas = new Object [peleas.size()][7]; 
    ...
    public static JRDataSource getDataSource(ObservableList<PeleaT> peleas){
        return new AleatorioDataSource(peleas);
    }
